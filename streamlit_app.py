...
def preprocess_image(img):
    """
    Функция предобрабатывает изображение для дальнейшего использования в модели.
    Изображение приводится к размеру (224, 224), нормализуется и добавляется размерность для батча.
